...
dd=70
ll= dd*10
obs = RandomObstructions(num=range(num_obstructions), draw=DRAW)
...
################
	...
	#for size in range(1000, 1300, density):
		...
		#for obstructions in range(num_obstructions, 60, 10):
			...
			#for run in range(1, 3, 1):
				...
				#if rrt.path:
					#print "Order: run, number of nodes, size, number of obstructions, time, path length, nodes expanded"
						## Order: run#, number of nodes, size, number of obstructions, time, path length, nodes expanded
